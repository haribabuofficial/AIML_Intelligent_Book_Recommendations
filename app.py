...
@st.cache_data
def load_data():
    return pd.read_csv(r"./files/clustered_books.csv")

@st.cache_resource
def load_models():
    tfidf = joblib.load(r"./files/tfidf_vectorizer.pkl")
    cosine_sim = joblib.load(r"./files/cosine_similarity_matrix.pkl")
